  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="141" valign="top" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo1">Soporte tecnico </p>
        <table width="97%"  border="0">
          <tr>
            <td><div align="center">
              <h5>&nbsp;</h5>
              <h5 class="Estilo2"><font size="4" face="Arial, Helvetica, sans-serif"><a href="../instrucciones/index.php"><font size="3">Instrucciones Recarga</font></a></font></h5>
              <h5><strong><a href="../../../archivos/instrucciones.interactivas/index.php">Instrucciones Recarga interactivas <br>
              </a>
              <a href="../../../archivos/instrucciones.interactivas/interactivo.zip" class="Estilo5">Descarga (2.646 KB)</a></strong></h5>
