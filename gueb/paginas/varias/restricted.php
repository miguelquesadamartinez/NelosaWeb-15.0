            ...
            <table width="100%"  border="0">
              <tr>
                <td height="95" valign="top"><div align="center" class="Estilo6">
                    <p>&nbsp;</p>
                    <p class="Estilo16">Zona de acceso solo para usuarios registrados</p>
                    <p class="Estilo16">
                <form action="../club/validationpages/check.php" name="Formulario_3" class="Estilo17" id="Formulario_3"  onSubmit="return validarDatos_3()" >
				<div align="center" class="Estilo6">
				<p class="Estilo18 Estilo17"><font face="Arial, Helvetica, sans-serif"><strong>Validese con su usuario <br> 
				  email 
				        <input name="user" type="text" class="Estilo18" size="8">
				        <br> 
				        Clave 
				        <input name="pwd" type="password" class="Estilo18" size="8">
				        <br>
				        <input name="Login" type="submit" class="Estilo18" value="Login" size="20">
				</strong><br>
				</font></p></div></form>
                    <p class="Estilo16"><span class="Estilo18 Estilo17"><font face="Arial, Helvetica, sans-serif"><a href="../club/validationpages/forgetPwd.php">Olvido su clave ? ! ? </a><BR>
                          <a href="../club/validationpages/registrar.php">Nuevo Usuario</a></font></span></p>
                    <p class="Estilo16"><font face="Arial, Helvetica, sans-serif"><a href="../../index.php"><img src="../../../img/diseno.paginas/comunes/varias/inicio.gif" width="32" height="34" border="0"></a></font></p>
                    <p align="center">&nbsp;</p>
                </div></td>
              </tr>
            </table>
