  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="141" valign="top" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo1">El Rincon Tecnico</p>
        <table width="97%"  border="0">
          <tr>
            <td><div align="center"> <span class="Estilo3"><a href="lo.basico.php">Lo basico a saber sobre las recargas
            </a> </span>
