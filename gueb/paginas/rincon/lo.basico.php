...
<HTML>
<HEAD>
<title>Lo B&aacute;sico a Saber sobre las Recargas</title>
  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td valign="top" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo1">Lo B&aacute;sico a Saber sobre las Recargas</p>
        <table width="97%"  border="0">
          <tr>
            <td width="100%"><span class="Estilo6">&iexcl;RECARGA ECOL&Oacute;GICA!</span><br>
              ...
              <p><span class="Estilo6">Los cartuchos para Ink-Jet o L&aacute;ser no se fabrican llenos de tinta </span><br>
                Primero lo fabrican y despu&eacute;s le introducen la tinta y lo envasan al vac&iacute;o para protegerlos del exterior, por lo tanto: <span class="Estilo6">Todos los cartuchos se pueden recargar </span></p>
              <p>En algunos casos los sistemas Anti-Recarga complicaran un poco la recarga. <br>
                <span class="Estilo6">TODOS TIENEN SOLUCION.</span><br>
                  <br>
