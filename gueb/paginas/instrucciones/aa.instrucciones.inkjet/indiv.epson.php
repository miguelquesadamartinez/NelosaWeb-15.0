...
<HTML>
<HEAD>
<title>Instrucciones recarga Cartuchos Individuales Epson</title>
...
.Estilo13 {font-weight: bold; color: #FF0000; }
</style>
</HEAD>
  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td valign="top" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo1">Instrucciones recarga Cartuchos Individuales Epson</p>
        <table width="97%"  border="0">
          <tr>
            <td width="81%">&nbsp;</td>
            <td width="19%"><p align="left" class="Estilo6"><span class="Estilo4"><br>
            </span> </p></td>
            </tr>
          <tr>
            <td colspan="2"><div align="center"><img src="../../../../img/a.inkjet/epson.indiv/imagen.jpg" width="649" height="185"></div>              <div align="center"></div></td>
            </tr>
          <tr>
            <td colspan="2">Cuando los indicadores del nivel de tinta indiquen que se agot&oacute; la tinta, solo resetear el chip, no recargar, y reutilizar un 35%. Disponer de otro juego de cartuchos, para reemplazar y que no se seque el cabezal al sacar los cartuchos.<br>
Para recargar sin quitar el cartucho y que sea mas f&aacute;cil, corte en la parte superior del cartucho como se indica.</td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td rowspan="2"><div align="center"><img src="../../../../img/a.inkjet/epson.indiv/figura2.jpg" width="100" height="153"></div></td>
          </tr>
          <tr>
            <td>Hacer DOS orificios, uno para la entrada de tinta y el otro para la salida del aire, perforando con el punz&oacute;n que se acompa&ntilde;a en el kit Nelosa, en el medio de lo cortado como indica la figura.2, o haga un solo orificio con taladro mas ancho que la aguja; El aire debe salir del cartucho mientras introduce tinta, sino puede salir chorro de tinta al retirar jeringuilla
              <p>Despu&eacute;s de introducir la tinta cierre los orificios de relleno herm&eacute;ticamente.</p>
              <p>Forzar la extracci&oacute;n de tinta a trav&eacute;s del cabezal, como indica la figura 3, para asegurar el flujo de tinta.</p>
              <p>Recomendamos cargar todos los cartuchos a la vez para evitar las cargas de tinta que hace la impresora al colocarle un cartucho nuevo ( o recargado )</p></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td colspan="2"><div align="center" class="Estilo13"><a href="sccr.php">Sistema continuo de carga rapida </a></div></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
