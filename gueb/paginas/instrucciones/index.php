          ...
          <table width="100%"  border="0">
            <tr>
              <td height="95" valign="top"><div align="center" class="Estilo6"> 
                <p>&nbsp;</p>
                <p align="center" class="Estilo2">Seleccione el tipo de impresora</p>
                <table width="97%"  border="0" align="center">
                  <tr>
                    <td><div align="center">
                        <p><a href="index.laser.php?page=index.laser.php"><img src="../../../img/diseno.paginas/comunes/logo-laser.jpg" width="236" height="297" border="0"></a></p>
                    </div></td>
                    <td><div align="center">
                        <p><a href="index.ink.jet.php?page=index.ink.jet.php"><img src="../../../img/diseno.paginas/comunes/logo-ink-jet.jpg" width="236" height="298" border="0"></a></p>
                    </div></td>
                  </tr>
                  <tr>
                    <td colspan="2">&nbsp;</td>
                  ...
                  <tr>
                    <td colspan="2"><div align="center">
                      <p><strong><a href="../rincon/index.php">Dudas sobre las impresoras, los cartuchos o las recargas consulta<br>
                        El Rincon Tecnico </a></strong><strong><a href="../rincon/impresoras.recomendadas.php"></a></strong></p>
                      </div></td>
                  </tr>
                </table>
                <p>&nbsp;</p>
