  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo4"> Instrucciones recarga HP Q397(0-1-2-3)A</p>
        <table width="97%"  border="0">
          <tr>
            <td><p align="center"><img src="../../../../img/a.laser/recarga/hp/Q397xA.jpg" width="425" height="136"></p>
              <p><strong>1. </strong>Destornille los tornillos que aguantan la tapa lateral. </p>
              <p align="center"><img src="../../../../img/a.laser/recarga/hp/Q397xA.2.jpg" width="170" height="68"><img src="../../../../img/a.laser/recarga/hp/Q397xA.3.jpg" width="170" height="102"><br>
                <br>
                <strong>2.</strong> Presione en la leng&uuml;eta y estire de la tapa, una vez retirada esta podr&aacute; ver el tap&oacute;n del orificio de relleno, ret&iacute;relo utilizando un destornillador plano. </p>
              <p align="center"><img src="../../../../img/a.laser/recarga/hp/Q397xA.4.jpg" width="113" height="162"></p>
              <p align="left"><br>
                  <strong>3. </strong>Para asegurar que el toner fluya correctamente de la bolsa, mu&eacute;vala un poco. <br>
                  <strong>4. </strong>Corte una peque&ntilde;a esquina de la bolsa, presione levemente para que el toner no salga e introduzca la punta recortada de la bolsa por el orificio de relleno.<br>
                  <strong>5. </strong>Cada una de las bolsas equivale a una recarga. <br>
                    <strong>6.</strong>                Cierre con el tap&oacute;n original el orificio de relleno. <br>
                  <strong>7. </strong>Pasada media hora, despu&eacute;s de que el cartucho este puesto en la impresora, compruebe que este no pierde toner. </p>              <p align="center" class="Estilo4"><strong> Esta impresora tiene un chip que se debe cambiar o reprogramar cada recarga </strong></p>
                  <p align="center"><img src="../../../../img/a.laser/recarga/hp/Q397xA.chip.jpg" width="113" height="75"></p>                
                  <p align="center">Consulte en <a href="http://www.nelosa.net">www.nelosa.net</a> o info@nelosa.net<br>
              </p></td>
          </tr>
        </table>
      </div></td>
