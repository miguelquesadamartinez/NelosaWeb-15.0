  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo4"> Instrucciones recarga HP 92298A</p>
        <table width="97%"  border="0">
          <tr>
            <td><p align="center"><img src="../../../../img/a.laser/recarga/hp/hp92298A.1.jpg" width="354" height="219"></p>
              <ol>
                <li> Hacer el orificio de relleno, como se muestra en la figura . </li>
              ...
              <p align="center" class="Estilo5">Como vaciar el deposito de toner residual </p>              
              <p align="center"><img src="../../../../img/a.laser/recarga/hp/hp92298A.1.2.jpg" width="354" height="219"></p>
              <p>1. Hacer el orificio de relleno, como se muestra en la figura . <br>
                2. Vaciar el deposito y vovela a tapar
              </p>
              <p>&nbsp;              </p>
              <p align="left">
                <?php
