  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo1"><strong>Instrucciones recarga Sharp ZT-81TD1</strong></p>
        <table width="97%"  border="0">
          <tr>
            <td><ol>
                ...
                <img src="../../../../img/a.laser/recarga/sharp/sharpZT-81TD1--2.jpg" width="180" height="377"> <img src="../../../../img/a.laser/recarga/sharp/sharpZT-81TD1--3.jpg" width="180" height="412"> </p>
              <p></p>
              <p>
                <?php
			  if (isset($proced)) {
