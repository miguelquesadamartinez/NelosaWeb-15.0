    ...
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <table width="97%"  border="0">
          <tr>
            <td><p align="center"><img src="../../../../img/a.inkjet/instrucciones/recarga/esp/Brother01.jpg" width="650" height="295"></p>
              <p><span class="Estilo4"><strong>1. </strong>Tape el orificio de salida de la tinta, en la base del cartucho con un trozo de PVC adhesivo.</span></p>
              <p class="Estilo4"><strong>2 .</strong> El orificio de relleno se encuentran debajo de la tapa, qu&iacute;tela procurando no da&ntilde;arla y retire la pegatina, si la hay, para descubrir el orificio de relleno</p>
              <p class="Estilo4"><strong>3 .</strong> Monte la jeringuilla y rellene con 5 ml de la tinta adecuada.</p>
              <p class="Estilo4"><strong>4 .</strong> Inserte la aguja por el orificio de relleno e inyecte tinta hasta que se llene, si el cartucho tiene un deposito triangular, este proceso deber&aacute; ser realizado hasta que la esponja deje de absorber tinta y el deposito este lleno, de esta forma la impresora reconocer&aacute; el cartucho como lleno.</p>
              <p class="Estilo4"><strong>5 .</strong> Despu&eacute;s del relleno, aseg&uacute;rese de tapar bien el orificio de relleno y ponga la tapa.</p>
              <p class="Estilo4"><strong>6 .</strong>D&eacute;jelo reposar en una superficie de pl&aacute;stico y destape el orificio de salida de la tinta.</p>              
              <p align="center" class="Estilo12"><strong><font color="#FF0000">Su impresora Brother no le reconoce el cartucho como lleno una vez recargado.</font></strong></p>
              <p align="left" class="Estilo12"><font color="#0000FF">Inserte la aguja por el orificio de relleno e inyecte tinta hasta que se llene deposito triangular, este proceso deber&aacute; ser realizado hasta que la esponja deje de absorber tinta y el deposito este lleno, de esta forma la impresora reconocer&aacute; el cartucho como lleno</font></p>
              <p align="center" class="Estilo12"><img src="../../../../img/a.inkjet/chip/brother/camara.crt.2.jpg" width="210" height="211"></p>
              <p></p>
              <p align="left"><br>
              </p>
              </td>
