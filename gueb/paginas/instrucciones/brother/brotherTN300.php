  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
          <p class="Estilo3 Estilo4"> <font color="#FF0000" face="Arial, Helvetica, sans-serif"><strong>Instrucciones 
            recarga Brother TN300</strong></font></p>
        <table width="97%"  border="0">
          <tr>
            <td><p align="center"><img src="../../../../img/a.laser/recarga/brother/brotherTN200.jpg" width="354" height="104"></p>
                <ol>
                  <p><font color="#0000FF" face="Arial, Helvetica, sans-serif">1. Hacer el orificio 
                    ...
                    puesto en la impresora, compruebe que este no pierde toner.</font><br>
                  </p>
                  <p>
                    <?php
