  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
          <p class="Estilo3 Estilo4"> <strong><font color="#FF0000" face="Arial, Helvetica, sans-serif">Instrucciones 
            recarga Brother TN9000</font></strong></p>
        <table width="97%"  border="0">
          <tr>
            <td><p align="center"><img src="../../../../img/a.laser/recarga/brother/brotherTN9000.jpg" width="496" height="307"></p>
                <p><font color="#0000FF" face="Arial, Helvetica, sans-serif">1. Hacer el orificio 
                  de relleno, como se muestra en la figura .<br>
                  2. No deben caer restos de pl&aacute;stico en el interior del 
                  cartucho, si no puede hacer que la impresi&oacute;n sea defectuosa, 
                  o incluso deteriorar el cartucho, por lo que recomendamos hacer 
                  el orificio con la parte que se va a agujerear mirando hacia 
                  un lado. Si ha ca&iacute;do alg&uacute;n trozo de pl&aacute;stico 
                  grande, utilice unas pinzas para extraer la pieza.<br>
                  3. Para asegurar que el toner fluya correctamente de la bolsa, 
                  mu&eacute;vala un poco.<br>
                  4. Corte una peque&ntilde;a esquina de la bolsa, presione levemente 
                  para que el toner no salga e introduzca la punta recortada de 
                  la bolsa por el orificio de relleno<br>
                  5. Cada una de las bolsas equivale a una recarga.<br>
                  6. Cierre con el adhesivo que se adjunta el orificio de relleno.<br>
                  7. Pasada media hora, despu&eacute;s de que el cartucho este 
                  puesto en la impresora, compruebe que este no pierde toner.</font></p>
                <p align="center"><font color="#FF0000" face="Arial, Helvetica, sans-serif"><strong>Como 
                  vaciar el deposito de toner residual</strong></font></p>
                <p align="center"><img src="../../../../img/a.laser/recarga/brother/brotherTN9000.2.jpg" width="591" height="365"></p>
                <p align="left"><font color="#0000FF" face="Arial, Helvetica, sans-serif">1. Hacer 
                  el orificio de relleno, como se muestra en la figura . <br>
                  2. Vaciar el deposito y volver a tapar</font><br>
                </p>
                <p align="left">
                  <?php
			  $resul = "../aa.procedures/".$proced.".php" ;
			  if ($proced != "") include ($resul);
			  ?>
                  <br>
                </p></td>
          </tr>
