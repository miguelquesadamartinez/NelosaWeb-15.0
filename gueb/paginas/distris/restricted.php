            ...
            <table width="100%"  border="0">
              <tr>
                <td height="95" valign="top"><div align="center" class="Estilo6">
                    <p>&nbsp;</p>
                    <p class="Estilo16">Zona de acceso solo para distribuidores y tiendas </p>
                    <p class="Estilo16">
                <form action="validationpages/check.php" name="Formulario_3" class="Estilo17" id="Formulario_3"  onSubmit="return validarDatos_3()" >
				...
				<p class="Estilo18 Estilo17"><font face="Arial, Helvetica, sans-serif"><strong>Validese con su usuario <br> 
				  email 
                    ...
                    <p class="Estilo16"><span class="Estilo18 Estilo17"><font face="Arial, Helvetica, sans-serif"><a href="validationpages/forgetPwd.php">Olvido su clave ? ! ? </a><BR>
                    <a href="validationpages/registrar.php">Nuevo Usuario</a></font></span></p>
