                  ...
                  <form action="send.php" name="Formulario_3" id="Formulario_3" >
                    <div align="center">
                      ...
                      <table border="0">
                        ...
                        <tr>
                          <td width="115" bgcolor="#FFFFCC">
                            <div align="right" class="Estilo1"><font size="2" face="Arial, Helvetica, sans-serif">Nombre : </font></div></td>
                          <td width="214"><b><font face="Arial, Helvetica, sans-serif">
                        ...
                        <tr>
                          <td width="115" bgcolor="#FFFFCC" height="29">
                            <div align="right" class="Estilo13"><font size="2" face="Arial, Helvetica, sans-serif">N&ordm; Ident. Fiscal </font></div></td>
                          <td width="214" height="29"><font color="#000066" size="2"><font face="Arial,Helvetica,Geneva,Swiss,SunSans-Regular" color="#000066" size="2"><b><font face="Arial, Helvetica, sans-serif">
                            <input type="text" name="hd_doc" id="hd_nombre4" size="35">
                          </font></b> </font></font></td>
                          <td width="95" bordercolor="#FFFFFF" bgcolor="#FFFFCC" height="29">
                            <div align="right" class="Estilo1"><font face="Arial, Helvetica, sans-serif" size="2">Empresa : </font></div></td>
                        ...
                        <tr>
                          ...
                          <td bgcolor="#FFFFCC" width="95">
                            <div align="right" class="Estilo1"><font size="2" face="Arial, Helvetica, sans-serif"><font size="2" face="Arial, Helvetica, sans-serif"><b>C. P. : </b></font></font></div></td>
                        ...
                        <tr>
                          <td width="115" bgcolor="#FFFFCC">
                            <div align="right" class="Estilo1"><font size="2" face="Arial, Helvetica, sans-serif">Pais : </font></div></td>
                          ...
                          <td width="95" bordercolor="#FFFFFF" bgcolor="#FFFFCC">
                            <div align="right" class="Estilo1"><font size="2" face="Arial, Helvetica, sans-serif"><font size="2" face="Arial, Helvetica, sans-serif"><b>Provincia</b></font> : </font></div>
