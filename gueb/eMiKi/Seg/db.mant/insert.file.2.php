...
//transformamos los saltos de l�nea en etiquetas <br>
$texto = nl2br($texto);

//echo $texto;

//Muy interesante la funcion nl2br (new line to break) que transforma los saltos de l�nea de un archivo texto en etiquetas <br>
