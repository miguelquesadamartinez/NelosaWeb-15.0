...
.Estilo8 {color: #0000FF; font-family: Arial, Helvetica, sans-serif;}
...
<table width="95%"  border="0" align="center">
  <tr>
    <td><div align="right" class="Estilo4"><a href="varios/some.info.php" target="_blank"><strong>Algo de informacion</strong></a></div></td>
  </tr>
</table>
<table width="95%"  border="1" align="center">
  <tr>
      ...
      <div align="center">
        <blockquote>
          <blockquote>
            ...
            <p><font color="#0000FF"><span class="Estilo5"><font face="Arial, Helvetica, sans-serif">Copiar el texto de las paginas que muestras<br>
          Seleccionar la base de datos, si no petara<br>
          Pinchar en enviar texto <br>
          Se habre una pagina, comprobar que las paginas web esten bien y pulsar enviar, en cada uno para guardarlo</font></span> </font> </p>
            <p>
              <?php
  ...
  <tr>
    <td bgcolor="#CCFFFF"><form action="mostrar.webs.php" method="post" name="form1" target="_blank">
      ...
      Busqueda total</font></strong></p>
        <p class="Estilo5"><span class="Estilo8">Muestra las webs guardas de la db seleccionada, al enviarla muestra los emails para pinchar y guardar, o mas paginas de la web <br>
          Dos secciones emails y links, pinchar en cada enviar que corresponda para guardar el email o le link <br>
  Los links que se guarden desede aqui, se deben volver a buscar desde aqu</span>i </p>
...
?>
    ...
    </form>      <div align="left" class="Estilo4"></div></td>
  </tr>
</table>
<table width="95%"  border="0" align="center">
  <tr>
    ...
    <td bgcolor="#CCCCCC"><div align="center">
        <form action="add.link.amarillas.php" method="post" name="form5" target="_blank" id="form5" >
          <p><font face="Arial, Helvetica, sans-serif">A&ntilde;adir web Paginas Amarillas<br>
            <span class="Estilo9">esto, teoricamente, le escribes parte del link y el genera todas las paginas de resultados </span>
          </font></p>
...
<p align="center"><a href="../ControlMenu.php"><img src="../../../imagenes/comunes/back.jpg" width="67" height="35" border="0"></a></p>
</body>
