...
<div align="center">
  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF">        <p align="center">&nbsp;</p>
            <div align="center">
              <table width="100%" border="0"">
                <tr>
                  <td align="center"><p><b><font color="#0000FF" size="4" face="Arial, Helvetica, sans-serif">
				  <?php echo getext($idioma,"title 063"); //Kits universales recarga Cartuchos Impresoras Ink-Jet?></font></b></p>
                    <p>
                      <?php 	
...
mysql_select_db("nelosa_nelosa",$link) ;
	...
	$result=mysql_query("select * from prods Where Grupo='01'" ,$link); 
