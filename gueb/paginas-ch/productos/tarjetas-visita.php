    ...
    <tr>
      <td height="0" valign="top" bgcolor="#FFFFFF"><div align="center">
          <table width="95%"  border="0">
            <tr>
              <td><p align="center">&nbsp;</p>
                <p align="center"><b><font color="#0000FF" face="Arial, Helvetica, sans-serif">
				<?php echo getext($idioma,"title 067"); // Tarjetas de visita?></font></b></p>
                <p align="center">
                    <?php 	
...
mysql_select_db("nelosa_nelosa",$link) ;
	...
	$result=mysql_query("select * from prods Where Grupo='11'" ,$link); 
