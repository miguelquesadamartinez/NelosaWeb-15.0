...
<div align="center">
  <?php 
  include ( "../../../eMiKi/Headers/nivel2/upper.ch.php" );
?>
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo4"><?php echo getext($idioma,"N126"); //Instrucciones recarga ?> Sharp ZT-50TD1</p>
        <table width="97%"  border="0">
          <tr>
            <td><?php echo getext($idioma,"N121"); // ?><ol>
              ...
              </ol>              <p align="center"><img src="../../../imagenes/ins/laser/sharp/sharpZT-50TD1.jpg" width="360" height="153"></p>
              <p align="center"><img src="../../../imagenes/ins/laser/sharp/sharpZT-50TD1--2.jpg" width="180" height="174"><img src="../../../imagenes/ins/laser/sharp/sharpZT-50TD1--3.jpg" width="180" height="178"></p>
              <p></p>
              <p>
                <?php
