  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo1"><strong><?php echo getext($idioma,"N126"); //Instrucciones recarga ?> Sharp ZT-81TD1</strong></p>
        <table width="97%"  border="0">
          <tr>
            <td><?php echo getext($idioma,"N121"); // ?><ol>
              ...
              </ol>              <p align="center"><br>
                <img src="../../../imagenes/ins/laser/sharp/sharpZT-81TD1--2.jpg" width="180" height="377"> <img src="../../../imagenes/ins/laser/sharp/sharpZT-81TD1--3.jpg" width="180" height="412"> </p>
              <p></p>
              <p>
                <?php
