...
<HTML>
<HEAD>
<title>Aide en ligne imprimante jet d'encre</title>
        ...
        <table width="758" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="196" height="509" valign="top" bgcolor="#FF8500"><p align="center"><strong><a href="consejos-generales.php"><?php echo getext($idioma,"title 039"); //General advices?></a></strong></p>
              <p align="center" class="Estilo4"><strong><a href="mantener-cartucho.php"><?php echo getext($idioma,"txt 015"); //How to maintain the cartridge in prefect conditions?></a></strong></p>
			  ...
			  <?php echo getext($idioma,"txt 017"); //Instructions for separated cartridges Epson C70 / C80 / CX5400 / C64 / C84 / R200 / R300
etc . . . ?></a></span></p>
