  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo4"> <?php echo getext($idioma,"N126"); //Instrucciones recarga ?> Lexmark 1382929 </p>
        <table width="97%"  border="0">
          <tr>
            <td><p align="center"><img src="../../../imagenes/ins/laser/lexmark/lexmark1382929.jpg" width="360" height="232"></p>
              <p>NOTA</p>
              <p>Antes de rellenar este cartucho deber&aacute; saber la capacidad, si tiene cartuchos para 7.500 &oacute; 10.000 paginas debe rellenar solo con la mitad del contenido de la bolsa. Este cartucho tiene un sensor que detecta si a este se le a&ntilde;ade mas toner del que tenia inicialmente, para asegurarse de no cometer errores cargue solo un tercio de la bolsa</p>
			  ...
			  <ol>
                ...
                <li>Pasada media hora, despu&eacute;s de que el cartucho este puesto en la impresora, compruebe que &eacute;ste no pierde toner.<br>
                  <p></p>
                  <p>
                    <?php
