   ...
   <table width="765" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo4"> <?php echo getext($idioma,"N126"); //Instrucciones recarga ?> Canon E-40 </p>
        <table width="97%"  border="0">
          <tr>
            <td><p align="center"><img src="../../../imagenes/ins/laser/canon/canonE40.jpg" width="360" height="169"></p>
              <ol>
              ...
              <p>&nbsp;</p>
              <p>Observation : </p>
              <p>Si la cartouche n'a pas &eacute;t&eacute; recharg&eacute;e, plus de deux fois et elle n'imprime pas correctement, la raison plus commune et que le r&eacute;servoir de surplus de toner est plein et il faut le vider. </p>
              <p><br>
              </p>
              <p>
                <?php
