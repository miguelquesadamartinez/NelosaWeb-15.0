...
<meta name="Publisher" content="Alma Print, http://www.alma-print"/>
<style TYPE="text/css">
  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo4"> <?php echo getext($idioma,"N126"); //Instrucciones recarga ?> Canon EP-P </p>
        <table width="97%"  border="0">
          <tr>
            <td><p align="center"><img src="../../../imagenes/ins/laser/canon/canonEPP.jpg" width="360" height="165"></p>
              <ol>
                ...
                <li>Mettez la cartouche dans l'imprimante et apr&egrave;s une demie heure s'assurer qu'il n'y est pas de fuite
                  <p></p>
                  <p>
                      <?php
