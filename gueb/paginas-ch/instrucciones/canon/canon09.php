  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo1"><img src="../../../imagenes/comunes/Logos/logo_Canon.gif" width="142" height="35" align="absmiddle"></p>
        <table width="97%"  border="0">
          <tr>
            <td class="Estilo1"><p align="center"><img src="../../../imagenes/ins/inkjet/esp/C9.jpg" width="374" height="280"></p>
              <p align="left"><font face="Arial, Helvetica, sans-serif"><?php echo getext($idioma,"Instrucciones Serie 04"); //Instrucciones recarga ?></font></p>              
              <p></p>
              <p>
                <?php
