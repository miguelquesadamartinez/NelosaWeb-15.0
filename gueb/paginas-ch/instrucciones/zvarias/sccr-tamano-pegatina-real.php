  ...
  <table width="765" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td valign="top" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo1">Sistema Continuo de Carga Rapida ( SCCR ) </p>
        <table width="97%"  border="0">
          <tr>
            <td><p align="center"><img src="../aimagenes/sccr/grafico2.jpg" width="91" height="266"> </p>
              </td>
            </tr>
        </table>
        <p align="right"><a href="sccr.php"><img src="../../../imagenes/comunes/back.jpg" width="67" height="35" border="0"></a> </p>
      </div></td>
      </tr>
    <tr>
