  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo4"><?php echo getext($idioma,"N126"); //Instrucciones recarga ?> Xerox 6R333</p>
        <table width="97%"  border="0">
          <tr>
            <td><?php echo getext($idioma,"N121"); // ?><ol>
              ...
              <p align="center"><img src="../../../imagenes/ins/laser/xerox/xerox6R333.jpg" width="360" height="133"></p>
              <p align="center"><img src="../../../imagenes/ins/laser/xerox/xerox6R333--2.jpg" width="180" height="259"><img src="../../../imagenes/ins/laser/xerox/xerox6R333--3.jpg" width="180" height="327"></p>
              <p></p>
              <p>
                <?php
