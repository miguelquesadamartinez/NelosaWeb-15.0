...
<HTML>
<HEAD>
<title>Instructions pour Apple</title>
  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo4"> <?php echo getext($idioma,"N126"); //Instrucciones recarga ?> Apple M0089LLA </p>
        <table width="97%"  border="0">
          <tr>
            <td><p align="center"><img src="../../../imagenes/ins/laser/apple/appleM0089LLA.jpg" width="360" height="142"></p>
              <p align="left">&nbsp;</p>
              <ol>
              ...
              <p>&nbsp;</p>              <p>Observation :</p>
              <p>A l'int&eacute;rieur de la cartouche il y a un cylindre qui doit tourner librement, si l'orifice n'est pas &agrave; la bonne place cela pourrait produire des bruits pendant l'impression et m&ecirc;me d&eacute;t&eacute;riorer la cartouche. </p>
              <p>&nbsp;</p>              
              <p></p>
              <p>
                <?php
