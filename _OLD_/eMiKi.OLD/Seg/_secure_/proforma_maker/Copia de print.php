...
<div align="center">
  ...
  <table width="641" border="0" align="center">
    <tr> 
      <td width="198"><div align="left"><img src="../../../../eMiKi/_images/zVarias/UpFac.jpg" width="169" height="220"></div></td>
      <td width="447" align="left" valign="bottom"> 
        <?php 
if ( $vv_nombre != "") echo $vv_nombre . "<BR>" ;
if ( $vv_ruc != "") echo $vv_ruc . "<BR>" ;
if ( $vv_direc != "") echo $vv_direc . "<BR>" ;
if ( $vv_direc2 != "") echo $vv_direc2 . "<BR>" ;
if ( $vv_pob != "") echo $vv_pob . "<BR>" ;
if ( $vv_pais != "") echo $vv_pais . "<BR>" ;
?>
        <div align="left"></div>
