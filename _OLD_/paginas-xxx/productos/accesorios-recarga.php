...
<HTML>
<HEAD>
<title>Accesorios recarga Ink-Jet</title>
    ...
    <tr>
      <td height="0" valign="top" bgcolor="#FFFFFF"><div align="center">
          ...
          <table width="95%"  border="0">
            <tr>
              <td><p align="center"><font color="#0000FF"><b><font face="Arial, Helvetica, sans-serif"><?php echo getext($idioma,"title 066"); // Accesorios recarga Ink-Jet?></font></b></font></p>
                  <p align="center">
                    <?php 	
...
mysql_select_db("nelosa_nelosa",$link) ;
	...
	$result=mysql_query("select * from prods Where Grupo='16'" ,$link); 
