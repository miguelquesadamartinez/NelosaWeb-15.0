...
<HTML>
<HEAD>
<title>Accesorios para Epson</title>
    ...
    <tr>
      <td height="0" valign="top" bgcolor="#FFFFFF"><div align="center">
          ...
          <table width="97%" border="0"">
            <tr>
              <td align="center"><p align="center"><font color="#0000FF"><b><font face="Arial, Helvetica, sans-serif"><?php echo getext($idioma,"title 065"); //Accesorios para Epson?></font></b></font></p>
                <p align="center">
                  <?php 	
...
mysql_select_db("nelosa_nelosa",$link) ;
	...
	$result=mysql_query("select * from prods Where Grupo='18' or Grupo='00'" ,$link); 
