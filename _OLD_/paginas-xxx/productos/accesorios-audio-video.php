...
<HTML>
<HEAD>
<title>Accesorios Audio Video</title>
    ...
    <tr>
      <td height="0" valign="top" bgcolor="#FFFFFF"><div align="center">
          ...
          <table width="97%" border="0"">
            <tr>
              <td align="center"><p><b><font color="#0000FF" size="4" face="Arial, Helvetica, sans-serif"><?php echo getext($idioma,"title 004"); // Accesorios?> <?php echo getext($idioma,"title 002"); // Imagen y sonido?></font></b> </p>
                  <p>
                    <?php 	
...
mysql_select_db("nelosa_nelosa",$link) ;
	...
	$result=mysql_query("select * from prods Where Grupo='02'" ,$link); 
