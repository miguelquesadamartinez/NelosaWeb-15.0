...
<table width="765"  border="0" align="center">
  <tr>
    ...
    <table width="763" border="0" cellpadding="0" cellspacing="0">
        ...
        <table width="765" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="78" height="13"><table width="765" border="0" cellpadding="0" cellspacing="0">
              <tr>
          ...
          <tr>
            <td valign="top" bgcolor="#FFFFFF"><div align="center">
                ...
                <table width="97%"  border="0">
                  <tr>
                    <td><p align="center"><font color="#0000FF" size="5" face="Arial, Helvetica, sans-serif">Password enviado a <b><?php echo $usr;?></b></font></p>
                        <p align="center"><font color="#0000FF" size="4" face="Arial, Helvetica, sans-serif">En breves minutos recibira su password a la direccion de correo indicada.</font></p></td>
                  </tr>
                </table>
                <p align="left">&nbsp; </p>
            </div></td>
