    ...
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        ...
        <table width="97%"  border="0">
          <tr>
            <td class="Estilo1"><p align="center"><img src="../../../imagenes/ins/inkjet/esp/HP10.jpg" width="490" height="304"></p>
              <p><font face="Arial, Helvetica, sans-serif"><?php echo getext($idioma,"Instrucciones HP 04"); //Instrucciones recarga ?></font></p>
              <p></p>
              <p>
                <?php
