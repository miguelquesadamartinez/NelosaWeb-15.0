  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo1"> <?php echo getext($idioma,"N126"); //Instrucciones recarga</span> ?></span> Xerox 6R737 </p>
        <table width="97%"  border="0">
          <tr>
            <td><?php echo getext($idioma,"N121"); // ?><ol>
              ...
              <p align="center"><img src="../../../imagenes/ins/laser/xerox/xerox6R737.jpg" width="360" height="141"></p>
              <p align="center"><img src="../../../imagenes/ins/laser/xerox/xerox6R737--2.jpg" width="180" height="361"><img src="../../../imagenes/ins/laser/xerox/xerox6R737--3.jpg" width="180" height="346"></p>
              <p></p>
              <p>
                <?php
			  if (isset($proced)) {
