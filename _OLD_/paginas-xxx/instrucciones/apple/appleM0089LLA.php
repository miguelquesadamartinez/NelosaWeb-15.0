        ...
        <table width="97%"  border="0">
          <tr>
            <td><p align="center"><img src="../../../imagenes/ins/laser/apple/appleM0089LLA.jpg" width="360" height="142"></p>
              ...
              <p>NOTA:</p>
              <p>Dentro del cartucho hay un rodillo que debe rotar libremente, si el orifico se hace desplazado podr&iacute;a producir ruidos durante la impresi&oacute;n, e incluso deteriorar el cartucho; Si este hace ruidos ign&oacute;relos mientras este imprima bien</p>              
              <p></p>
              <p>
                <?php
