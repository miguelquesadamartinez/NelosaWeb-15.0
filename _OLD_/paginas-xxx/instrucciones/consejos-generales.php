...
?>
    ...
    <tr>
      <td height="0" valign="top" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo1"><strong><?php echo getext($idioma,"title 041"); //Consejos generales de recarga?> </strong></p>
        <table width="97%"  border="0">
          <tr>
            <td><p align="left" class="Estilo2"><?php echo getext($idioma,"Instrucciones generales"); //?></p>
              </td>
          </tr>
        </table>
        <p align="left">&nbsp;        </p>
