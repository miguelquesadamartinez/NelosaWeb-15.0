    ...
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        ...
        <table width="97%"  border="0">
          <tr>
            <td class="Estilo1"><p align="center"><img src="../../../imagenes/ins/inkjet/esp/Epson01.jpg" width="528" height="285"></p>
              <p><?php echo getext($idioma,"Instrucciones Epson 01"); //Instrucciones recarga ?></p>
              <p>
			  <?php
