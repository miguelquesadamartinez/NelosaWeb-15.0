  ...
  <table width="765" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo4"> <?php echo getext($idioma,"N126"); //Instrucciones recarga ?> Epson S051016 </p>
        <table width="97%"  border="0">
          <tr>
            <td><p align="center"><img src="../../../imagenes/ins/laser/epson/epsonS051016.jpg" width="360" height="344"></p>
              <ol>
