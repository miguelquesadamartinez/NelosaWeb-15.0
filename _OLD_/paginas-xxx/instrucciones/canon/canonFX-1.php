  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="0" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
        <p>&nbsp;</p>
        <p class="Estilo3 Estilo4"> <?php echo getext($idioma,"N126"); //Instrucciones recarga ?>a Canon FX-1 </p>
        <table width="97%"  border="0">
          <tr>
            <td><p align="center"><img src="../../../imagenes/ins/laser/canon/canonFX1.jpg" width="360" height="145"></p>
              <ol>
              ...
              <p>NOTA:</p>
              <p>En la c&aacute;mara donde se almacena el toner, hay un rodillo que debe rotar libremente, por lo que debe hacer el orificio justamente en el lugar indicado y de menos de 1 cm de di&aacute;metro</p>              
              <p></p>
              <p>
                <?php
			  if (isset($proced)) {
