        ...
        <table width="97%"  border="0">
          <tr>
            <td><p align="center"><img src="../../../imagenes/ins/laser/canon/canonE20.jpg" width="360" height="163"></p>
              ...
              <p>NOTA:</p>
              <p>Si el cartucho no se ha recargado mas 2 veces, y no imprime correctamente, el motivo mas usual es por el peque&ntilde;o deposito de toner sobrante, el cual se ha llenado y debe ser vaciado</p>
              <p><br>
              </p>
              <p>
                <?php
